...
| UT-UI-004 | Inputs `(page, totalCount, pageSize)`: `(3, 41, 20)`, `(2, 0, 20)`, `(1, 0, 20)`, `(3, 40, 20)` | Call the last-available-page calculator | Returns `2`, `1`, `1`, `2` respectively: `max(1, ceil(totalCount / pageSize))` — never `0`, never above the last page; current page kept when still valid. Behavior observable end-to-end in IT-UI-009/017 | REQ-UI-001; VER-UI-002; C7 |
